...
const errorHandlerMiddleware = (err, req, res, next) => {
  ...
  // Security: In production, hide detailed 500 errors to prevent database / server dump exposure
  if (statusCode === 500 && process.env.NODE_ENV === "production") {
    console.error("🔥 Detailed Production Error Context:", err);
    message =
      "Something went wrong on the server. Please contact support or try again later.";
  }
