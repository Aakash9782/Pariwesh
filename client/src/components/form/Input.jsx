    ...
    return (
      <div className={`flex flex-col space-y-1.5 w-full ${className}`}>
        ...
        <input
          ...
          } text-base md:text-xs px-4 py-3 rounded-input text-textPrimary placeholder-textSecondary focus:outline-none focus:ring-1 focus:ring-accent-gold transition-all`}
          {...props}
        />
        {error && (
